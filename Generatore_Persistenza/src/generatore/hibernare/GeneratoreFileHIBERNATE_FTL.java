...
public class GeneratoreFileHIBERNATE_FTL {

	private Configuration configuration;

	public GeneratoreFileHIBERNATE_FTL() throws IOException {		
	...
	public void generateJavaManagerFiles(Manager classSpecification,String inputPath, String nomeFile, File outputDirectory)throws Exception {
		Map<String, Object> freemarkerDataModel = new HashMap<>();
		...
		//for (ClasseProblema classSpecification : classSpecifications) {
			// Put the classSpecification into the data model.
			// It can  be accessed in the template through ${classSpecification}
			freemarkerDataModel.put("manager", classSpecification);
			// The Java source file will be generated in the same directory as the YAML file
			File javaSourceFile = new File(outputDirectory, nomeFile);
			Writer beanFileWriter = new FileWriter(javaSourceFile);
	...
	public void generateJavaHIBERNATETest(List<Manager> managers, String input, String nomeFile, File outputDirectory)throws Exception {
		Map<String, Object> freemarkerDataModel = new HashMap<>();

		Template template = configuration.getTemplate(input);

		freemarkerDataModel.put("managers", managers);
