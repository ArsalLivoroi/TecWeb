...
//			 return new MySqlDAOFactory();
	 ...
	 * for the datatype WorkPackage
	 */
	public abstract WorkPackageDAO getWorkPackageDAO();
	
	/**
	 * Method to obtain a DATA ACCESS OBJECT
	 * for the datatype WorkPackagePartnerMapping
	 */
	public abstract WorkPackagePartnerMappingDAO getWorkPackagePartnerMappingDAO();
	
	/**
	 * Method to obtain a DATA ACCESS OBJECT
	 * for the datatype Progetto
	 */
	public abstract ProgettoDAO getProgettoDAO();
	
	/**
	 * Method to obtain a DATA ACCESS OBJECT
	 * for the datatype Partner
	 */
