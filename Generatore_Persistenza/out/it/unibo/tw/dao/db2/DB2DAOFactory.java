...
public class DB2DAOFactory extends DAOFactory {
	...
	// --------------------------------------------
		...
		@Override
	public WorkPackageDAO getWorkPackageDAO() {
		return new DB2WorkPackageDAO();
	}
	
	@Override
	public WorkPackagePartnerMappingDAO getWorkPackagePartnerMappingDAO() {
		return new DB2WorkPackagePartnerMappingDAO();
	}
	
	@Override
	public ProgettoDAO getProgettoDAO() {
		return new DB2ProgettoDAO();
	}
	
	@Override
	public PartnerDAO getPartnerDAO() {
		return new DB2PartnerDAO();
	}
